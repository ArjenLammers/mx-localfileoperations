...
public class UserActionsRegistrar
{
  public void registerActions(IActionRegistrator registrator)
  {
    ...
    registrator.registerUserAction(localfileoperations.actions.CleanDirectory.class);
    registrator.registerUserAction(localfileoperations.actions.CopyDirectory.class);
    registrator.registerUserAction(localfileoperations.actions.CopyFile.class);
    registrator.registerUserAction(localfileoperations.actions.CreateParentDirectories.class);
    registrator.registerUserAction(localfileoperations.actions.Delete.class);
    registrator.registerUserAction(localfileoperations.actions.Exists.class);
    registrator.registerUserAction(localfileoperations.actions.FileDocumentToFile.class);
    registrator.registerUserAction(localfileoperations.actions.FileToFileDocument.class);
    registrator.registerUserAction(localfileoperations.actions.GetCurrentDirectory.class);
    registrator.registerUserAction(localfileoperations.actions.GetParent.class);
    registrator.registerUserAction(localfileoperations.actions.GetSeparator.class);
    registrator.registerUserAction(localfileoperations.actions.GetTempDirectoryPath.class);
    registrator.registerUserAction(localfileoperations.actions.List.class);
    registrator.registerUserAction(localfileoperations.actions.MkDir.class);
    registrator.registerUserAction(localfileoperations.actions.MoveDirectory.class);
    registrator.registerUserAction(localfileoperations.actions.MoveFile.class);
    registrator.registerUserAction(localfileoperations.actions.ReadFileToString.class);
    registrator.registerUserAction(localfileoperations.actions.Touch.class);
    registrator.registerUserAction(localfileoperations.actions.WriteStringToFile.class);
